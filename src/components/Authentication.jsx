...
const links = [
    { name: <FaGithub className="text-[25px]" />, href: 'https://github.com/Amidah-ifeoluwa/signin-and-login' },
    { name: <FaGlobe className="text-[25px]" />, href: 'https://loginandsignin.netlify.app/' },
]
